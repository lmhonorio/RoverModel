...
local pwm_sequences_1 = {
  { pwm = {-100, 100, 100, -100}, duration = 1.9 },    -- máxima potencia para frente
  { pwm = {80, -80, -80, 80}, duration = 1.7 },      -- máxima potencia para trás
  { pwm = {-40, 60, 60, -40}, duration = 1.6 },      -- curva para a direita
  { pwm = {90, -70, -70, 90}, duration = 2.0 },      -- ré com curva fechada
  { pwm = {-50, 50, 50, -50}, duration = 1.8 },      -- Movimento reto devagar
  { pwm = {100, -100, -100, 100}, duration = 1.5 },  -- Ré total
  { pwm = {-80, 80, 80, -80}, duration = 1.6 },      -- Movimento reto médio
  { pwm = {-60, 100, 100, -60}, duration = 1.9 },      -- Curva fechada para direita
  { pwm = {70, -50, -50, 70}, duration = 1.7 },      -- Curva em ré
  { pwm = {-70, 70, 70, -70}, duration = 1.5 }       -- Movimento reto médio
}
