...
local pwm_sequences_1 = {
  { pwm = {-80, 100, 100, -80}, duration = 1.8 },    -- Curva suave para a direita
  { pwm = {60, -40, -40, 60}, duration = 1.7 },      -- Ré com curva leve
  { pwm = {-90, 90, 90, -90}, duration = 2.0 },      -- Movimento reto rápido
  { pwm = {30, 40, 40, 30}, duration = 1.6 },        -- Movimento misto para testar controle
  { pwm = {-50, 50, 50, -50}, duration = 1.9 },      -- Movimento reto devagar
  { pwm = {100, -80, -80, 100}, duration = 2.0 },    -- Ré rápida curva para esquerda
  { pwm = {-70, 70, 70, -70}, duration = 1.7 },      -- Movimento reto médio
  { pwm = {90, -90, -90, 90}, duration = 1.5 },      -- Ré em alta velocidade
  { pwm = {-60, 80, 80, -60}, duration = 1.8 },      -- Curva controlada para a direita
  { pwm = {50, -50, -50, 50}, duration = 1.6 }       -- Ré lenta
}
