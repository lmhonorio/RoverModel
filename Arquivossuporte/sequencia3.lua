...
local pwm_sequences_1 = {
  { pwm = {-60, 100, 80, -50}, duration = 1.8 },    -- Curva assimétrica para frente
  { pwm = {40, -90, -60, 30}, duration = 1.7 },      -- Ré com inclinação variável
  { pwm = {-70, 80, 100, -60}, duration = 1.9 },      -- Movimento irregular para frente
  { pwm = {80, -50, -70, 60}, duration = 1.6 },        -- Ré com variação entre rodas
  { pwm = {-90, 60, 50, -100}, duration = 1.5 },      -- Controle de direção instável
  { pwm = {-40, 30, 100, -80}, duration = 1.7 },    -- Aceleração diferenciada por lado
  { pwm = {70, -100, -90, 50}, duration = 1.8 },      -- Ré intensa com assimetria
  { pwm = {-80, 50, 70, -40}, duration = 1.9 },      -- Controle não linear
  { pwm = {-30, 60, -90, 40}, duration = 2.0 },      -- Curva controlada para a direita
  { pwm = {-50, 90, 60, -100}, duration = 1.6 }       -- Ré lenta
}
