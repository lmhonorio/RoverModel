...
#
# df["Py"] = df["Latitude"].apply(lambda x: posicao_em_metros(x, med_latitude))
# df["Px"] = df["Longitude"].apply(lambda x: posicao_em_metros(x, med_longitude))
#
# # Criar novas colunas
...
# output_path = "obstaculos_processado3.xlsx"
